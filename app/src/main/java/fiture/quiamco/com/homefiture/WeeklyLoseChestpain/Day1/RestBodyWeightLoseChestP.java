...
public class RestBodyWeightLoseChestP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rest_body_weight_lose_chest_p);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(RestBodyWeightLoseChestP.this, BodyWeightSquat.class);
                startActivity(im);
            }
        });
                ...
                finish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (seconds == 0) {
                            ...
                            Intent intent = new Intent(RestBodyWeightLoseChestP.this, InsLying.class);
                            startActivity(intent);
                        } else {
