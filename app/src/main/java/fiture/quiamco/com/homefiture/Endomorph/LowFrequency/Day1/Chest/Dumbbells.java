...
import fiture.quiamco.com.homefiture.Endomorph.LowFrequency.Day1.Chest.Back.Deadlift;
...
public class Dumbbells extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dumbbells1);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Dumbbells.this,Deadlift.class);
