...
import fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day4ShouldersCalvesAbs.Calves.BarbellSeated;
...
public class MilitaryPress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_military_press);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(MilitaryPress.this,MilitaryPress.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MilitaryPress.this, BarbellSeated.class);
