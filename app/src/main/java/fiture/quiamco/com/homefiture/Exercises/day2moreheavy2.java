...
//        loadImage();
        ...
        start_timer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myCountDownTimer = new day2moreheavy2.MyCountDownTimer(10000, 1000);
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Lie back on a flat bench. Using a medium width grip , " +
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(day2moreheavy2.this, day2moreheavy3.class);
                startActivity(step);
