...
import fiture.quiamco.com.homefiture.LoseExcercise.Friday.Instructions.InsSquatsLegSide;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class RestThighSlapJumps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rest_thigh_slap_jumps);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(RestThighSlapJumps.this,Weekly.class);
                startActivity(im);
            }
        });
