...
import fiture.quiamco.com.homefiture.LoseExcercise.Friday.PushUpsOblique;
...
public class InsPushUpsOblique extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ins_push_ups_oblique);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(InsPushUpsOblique.this,Weekly.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InsPushUpsOblique.this,PushUpsOblique.class);
