...
public class RestCrunch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rest_crunch);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(getApplication(),crunch.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (surveyResponseRef.child(userId).equals(userId)) {
                    ...
                    surveyResponseRef.child(userId).child("Maintain").child("Day1").child("Exercise 3").setValue("Rollout");
                    surveyResponseRef.child(userId).child("Maintain").child("Day1").child("Exercise 4").setValue("KneeTucks");
                    surveyResponseRef.child(userId).child("Maintain").child("Day1").child("Exercise 5").setValue("Spiderman");
                    surveyResponseRef.child(userId).child("Maintain").child("Day1").child("Exercise 6").setValue("Side Lift");
                    surveyResponseRef.child(userId).child("Maintain").child("Day1").child("Exercise 7").setValue("Oblique Crunch");
                    surveyResponseRef.child(userId).child("Maintain").child("Status").setValue("done");
                    startActivity(intent);
                }
            }
        });
        surveyResponseRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                String value =  dataSnapshot.child("Exercise 7").getValue(String.class);
                Log.d("HOOYYY",value);
            }
