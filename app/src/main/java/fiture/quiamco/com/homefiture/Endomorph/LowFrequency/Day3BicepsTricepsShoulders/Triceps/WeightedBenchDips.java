package fiture.quiamco.com.homefiture.Endomorph.LowFrequency.Day3BicepsTricepsShoulders.Triceps;
...
import fiture.quiamco.com.homefiture.Endomorph.LowFrequency.Day3BicepsTricepsShoulders.Biceps.PreacherCurl;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class WeightedBenchDips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weighted_bench_dips2);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(WeightedBenchDips.this, PreacherCurl.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WeightedBenchDips.this,SkullCrushers.class);
