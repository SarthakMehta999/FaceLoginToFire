...
import fiture.quiamco.com.homefiture.ChestExercises.Dumbbells;
...
public class WeightedBenchDips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weighted_bench_dips);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(WeightedBenchDips.this,Dumbbells.class);
                startActivity(im);
            }
        });
