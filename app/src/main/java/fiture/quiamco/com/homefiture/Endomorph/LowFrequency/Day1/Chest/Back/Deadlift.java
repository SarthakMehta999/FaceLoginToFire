...
import fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day1.Dumbbells;
...
public class Deadlift extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deadlift1);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(Deadlift.this,Dumbbells.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Deadlift.this, BentOverBarbellRow.class);
