...
//        loadImage();
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.)Descend until knees and hips are fully bent or until thighs are just past parallel to floor. " +
                                "Knees travel outward in direction of toes." +
                            ...
                            matchesRefTemp.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.hasChild("6")){
                                        Log.d("idOy","naaJOD");
                                        final DatabaseReference ref0 = dataSnapshot.getRef().child("6");
                                        final DatabaseReference ref1 = dataSnapshot.getRef().child("7");
                                                            ...
                                                            if(dataSnapshot.hasChild(id)){
                                                                ...
                                                                refUserID.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                                        ref1.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                            ...
                                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                                ...
                                                                                if(status.equalsIgnoreCase("lock")){
                                                                                    Toast.makeText(day1heavy.this, "You have unlocked a new exercise!", Toast.LENGTH_SHORT).show();
                                                                                    ref1.child("status").setValue("unlock1");
                                                                                }
                                                                            }
                                                                        ...
                                                                        userPoints+=30;
                                                                        Toast.makeText(day1heavy.this, "Congratulations, you received 30 points!", Toast.LENGTH_LONG).show();
                                                                        refUserID.child("userPoints").setValue(userPoints);
                                                                        user.setUserPoints(String.valueOf(userPoints));
                                                                        Intent proc = new Intent(day1heavy.this, NavDrawer.class);
