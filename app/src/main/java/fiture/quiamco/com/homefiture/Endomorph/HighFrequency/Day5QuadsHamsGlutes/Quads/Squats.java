package fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day5QuadsHamsGlutes.Quads;
...
import fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day5QuadsHamsGlutes.Hams.CleanDeadlift;
...
public class Squats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squats3);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(Squats.this,Lunge.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Squats.this, CleanDeadlift.class);
