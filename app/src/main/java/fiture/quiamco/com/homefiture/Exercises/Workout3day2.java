                                                            ...
                                                            if(dataSnapshot.hasChild(id)){
                                                                ...
                                                                refUserID.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                                        ...
                                                                        userPoints+=30;
                                                                        Toast.makeText(Workout3day2.this, "Congratulations, you received 30 points!", Toast.LENGTH_LONG).show();
                                                                        refUserID.child("userPoints").setValue(userPoints);
                                                                        user.setUserPoints(userPoints);
                                                                        Intent proc = new Intent(Workout3day2.this, NavDrawer.class);
