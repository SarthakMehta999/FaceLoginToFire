...
public class exercise2mostheavyd2 extends AppCompatActivity {
    GifTextView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise2mostheavyd2);
...
//        loadImage();
        ...
        start_timer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myCountDownTimer = new exercise2mostheavyd2.MyCountDownTimer(10000, 1000);
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Set an adjustable bench to a 30- to 45-degree angle and lie back on it. " +
                                "Grasp the bar with hands at shoulder width and raise your elbows until your " +
                                "upper arms are parallel to the floor. " +
                                "2.) Grasp the bar just outside shoulder width, arch your back, and pull it off the rack." +
                                "  " +
                                "3.)Lower the bar to the upper part of your chest and then drive. " +
                                "your feet into the floor as you press it back up.")
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(exercise2mostheavyd2.this, exercise3mostheavyd2.class);
                startActivity(step);
