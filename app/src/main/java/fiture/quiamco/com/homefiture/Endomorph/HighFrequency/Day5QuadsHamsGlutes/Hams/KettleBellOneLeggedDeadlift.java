...
public class KettleBellOneLeggedDeadlift extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kettle_bell_one_legged_deadlift);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(KettleBellOneLeggedDeadlift.this,CleanDeadlift.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(KettleBellOneLeggedDeadlift.this, RomanianDeadlift.class);
