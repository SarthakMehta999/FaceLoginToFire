package fiture.quiamco.com.homefiture.LoseExcercise.Tuesday.Rest;
...
import fiture.quiamco.com.homefiture.LoseExcercise.Tuesday.ModeratePaceJog;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class RestModeratePace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rest_moderate_pace);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RestModeratePace.this, WeeklyLose.class);
