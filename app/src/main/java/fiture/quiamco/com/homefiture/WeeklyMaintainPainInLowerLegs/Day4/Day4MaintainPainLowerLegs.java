    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                equipments1 = (Button) findViewById(R.id.equipmentsthursdaymaintainpainlowerlegs1);
                equipments2 = (Button) findViewById(R.id.equipmentsthursdaymaintainpainlowerlegs2);
                equipments3 = (Button) findViewById(R.id.equipmentsthursdaymaintainpainlowerlegs3);
                equipments4 = (Button) findViewById(R.id.equipmentsthursdaymaintainpainlowerlegs4);
                equipments5 = (Button) findViewById(R.id.equipmentsthursdaymaintainpainlowerlegs5);
                equipments6 = (Button) findViewById(R.id.equipmentsthursdaymaintainpainlowerlegs6);
                equipments7 = (Button) findViewById(R.id.equipmentsthursdaymaintainpainlowerlegs7);
                equipments8 = (Button) findViewById(R.id.equipmentsthursdaymaintainpainlowerlegs8);
