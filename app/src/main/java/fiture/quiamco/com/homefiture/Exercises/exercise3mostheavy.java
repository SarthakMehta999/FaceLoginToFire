...
public class exercise3mostheavy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise3mostheavy);
                            ...
                            matchesRefTemp.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.hasChild("2")){
                                        Log.d("idOy","naaJOD");
                                        final DatabaseReference ref0 = dataSnapshot.getRef().child("2");
                                                            ...
                                                            if(dataSnapshot.hasChild(id)){
                                                                ...
                                                                refUserID.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                                        ...
                                                                        userPoints+=30;
                                                                        Toast.makeText(exercise3mostheavy.this, "Congratulations, you received 30 points!", Toast.LENGTH_LONG).show();
                                                                        refUserID.child("userPoints").setValue(userPoints);
                                                                        user.setUserPoints(userPoints);
                                                                        Intent proc = new Intent(exercise3mostheavy.this, NavDrawer.class);
