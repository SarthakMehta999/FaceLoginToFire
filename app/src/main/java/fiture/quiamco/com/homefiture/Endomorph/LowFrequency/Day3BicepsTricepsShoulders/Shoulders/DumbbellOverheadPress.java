package fiture.quiamco.com.homefiture.Endomorph.LowFrequency.Day3BicepsTricepsShoulders.Shoulders;
...
import fiture.quiamco.com.homefiture.Endomorph.LowFrequency.Day3BicepsTricepsShoulders.Triceps.SkullCrushers;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class DumbbellOverheadPress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dumbbell_overhead_press2);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(DumbbellOverheadPress.this, SkullCrushers.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DumbbellOverheadPress.this,MilitaryPress.class);
