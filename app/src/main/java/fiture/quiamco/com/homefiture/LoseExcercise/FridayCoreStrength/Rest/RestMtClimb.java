...
import fiture.quiamco.com.homefiture.LoseExcercise.FridayCoreStrength.Instructions.InsThighSlapJumps;
import fiture.quiamco.com.homefiture.LoseExcercise.FridayCoreStrength.MtClimb;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class RestMtClimb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rest_mt_climb);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(RestMtClimb.this,MtClimb.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RestMtClimb.this, InsThighSlapJumps.class);
