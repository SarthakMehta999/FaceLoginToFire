...
public class Day2Step1_1 extends AppCompatActivity {
    GifTextView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day2_step1_1);
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(Day2Step1_1.this, day2Step2_2.class);
                startActivity(step);
