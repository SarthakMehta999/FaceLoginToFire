...
public class Day3GReadyPullUps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day3_gready_pull_ups);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Day3GReadyPullUps.this, Day3GAbCircuits.class);
