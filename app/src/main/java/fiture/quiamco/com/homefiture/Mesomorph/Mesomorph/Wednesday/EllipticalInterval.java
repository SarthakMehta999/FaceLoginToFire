package fiture.quiamco.com.homefiture.Mesomorph.Mesomorph.Wednesday;
...
public class EllipticalInterval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elliptical_interval);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EllipticalInterval.this, WeeklyMesomorph.class);
