...
public class exercise2mostheavyd3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise2mostheavyd3);
...
//        loadImage();
        ...
        start_timer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myCountDownTimer = new exercise2mostheavyd3.MyCountDownTimer(10000, 1000);
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(exercise2mostheavyd3.this, exercise3mostheavyd3.class);
                startActivity(step);
