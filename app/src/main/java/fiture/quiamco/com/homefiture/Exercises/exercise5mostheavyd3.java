...
public class exercise5mostheavyd3 extends AppCompatActivity {
    GifTextView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise5mostheavyd3);
...
//        loadImage();
        ...
        start_timer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myCountDownTimer = new exercise5mostheavyd3.MyCountDownTimer(10000, 1000);
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Perform an overhead press as directed previously, but use one arm " +
                                "at a time and turn your palm to face in. ")
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(exercise5mostheavyd3.this, exercise6mostheavyd3.class);
                startActivity(step);
