package fiture.quiamco.com.homefiture.Endomorph.MediumFrequency.Day2BackShoulders.Back;
...
import fiture.quiamco.com.homefiture.Endomorph.MediumFrequency.Day2BackShoulders.Shoulders.DumbbellOverheadPress;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class BentOverBarbellRow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bent_over_barbell_row3);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(BentOverBarbellRow.this,Deadlift.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BentOverBarbellRow.this, DumbbellOverheadPress.class);
