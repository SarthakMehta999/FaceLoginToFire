...
public class exercise1mostheavyd2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise1mostheavyd2);
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(exercise1mostheavyd2.this, exercise2mostheavyd2.class);
                startActivity(step);
