package fiture.quiamco.com.homefiture.BackExercises;
...
import fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day2BackandBiceps.BarbellCurl;
...
public class BentOverBarbellRow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bent_over_barbell_row);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BentOverBarbellRow.this, BarbellCurl.class);
