package fiture.quiamco.com.homefiture.Ectomorph.Day1ChestandTriceps;
...
public class InclinePress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(InclinePress.this,DumbellBenchPress.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(InclinePress.this, DumbellFlyers.class);
