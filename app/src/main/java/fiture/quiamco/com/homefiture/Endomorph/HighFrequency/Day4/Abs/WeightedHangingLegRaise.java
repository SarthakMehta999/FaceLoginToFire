package fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day4.Abs;
...
public class WeightedHangingLegRaise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weighted_hanging_leg_raise);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(WeightedHangingLegRaise.this,Exercisesday3.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WeightedHangingLegRaise.this, WeeklyEndomorphHighFreq.class);
