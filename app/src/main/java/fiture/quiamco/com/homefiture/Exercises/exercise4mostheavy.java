...
public class exercise4mostheavy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise4mostheavy);
            ...
            public void onClick(View view){
                ...
                alertDialogBuilder
                        .setMessage("1.) Lie back on a flat bench with a dumbbell in each hand. " +
                                "   2.) Keep a slight bend in your elbows and spread your arms wide,. " +
                            ...
                            matchesRefTemp.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.hasChild("3")){
                                        Log.d("idOy","naaJOD");
                                        final DatabaseReference ref0 = dataSnapshot.getRef().child("3");
                                                            ...
                                                            if(dataSnapshot.hasChild(id)){
                                                                ...
                                                                refUserID.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                                        ...
                                                                        userPoints+=30;
                                                                        Toast.makeText(exercise4mostheavy.this, "Congratulations, you received 30 points!", Toast.LENGTH_LONG).show();
                                                                        refUserID.child("userPoints").setValue(userPoints);
                                                                        user.setUserPoints(userPoints);
                                                                        Intent proc = new Intent(exercise4mostheavy.this, NavDrawer.class);
