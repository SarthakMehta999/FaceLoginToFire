...
import fiture.quiamco.com.homefiture.ExerciseCategories.WeeklyLosePainInLegs;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.WeeklyLosePainInLegs.Day1Instructions.InsHipFlexorsStretch;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class HipFlexorsStretch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hip_flexors_stretch);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(getApplication(),InsHipFlexorsStretch.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplication(), WeeklyLosePainInLegs.class);
