package fiture.quiamco.com.homefiture.Maintain.SatCardio;
...
public class BenchPressIncline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bench_press_incline);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(BenchPressIncline.this,MaintainWeekly.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BenchPressIncline.this, BenchPressDecline.class);
