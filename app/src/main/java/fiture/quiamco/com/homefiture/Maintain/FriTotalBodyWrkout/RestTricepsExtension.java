...
public class RestTricepsExtension extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rest_triceps_extension);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(getApplication(),TricepsExtension.class);
                startActivity(im);
            }
        });
