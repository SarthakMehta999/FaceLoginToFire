...
public class AlternatingCurls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alternating_curls);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(AlternatingCurls.this,StandingBarbellCurls.class);
                startActivity(im);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AlternatingCurls.this, WeeklyEctomorph.class);
