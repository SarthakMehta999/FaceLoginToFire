...
public class exercise1mostheavy extends AppCompatActivity {
...
//        loadImage();
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Set a barbell on a power rack at about shoulder height. " +
                                "Grasp the bar with hands at shoulder width and raise your elbows until your " +
                                "upper arms are parallel to the floor. " +
                                "Take the bar out of the rack and let it rest on your fingertips as long as your elbows stay up, " +
                                "you'll be able to balance the bar." +
                                "  " +
                                "2.)Step back and set your feet at shoulder width with toes turned out slightly. " +
