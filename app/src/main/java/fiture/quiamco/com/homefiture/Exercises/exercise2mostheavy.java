...
public class exercise2mostheavy extends AppCompatActivity {
...
//        loadImage();
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Hang from a pullup bar with hands at shoulder width and " +
                                "palms facing each other.  " +
                                "Pull yourself up until your chin is over the bar. " +
                                "Stop each set two reps shy of failure.")
                            ...
                            matchesRefTemp.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.hasChild("1")){
                                        Log.d("idOy","naaJOD");
                                        final DatabaseReference ref0 = dataSnapshot.getRef().child("1");
