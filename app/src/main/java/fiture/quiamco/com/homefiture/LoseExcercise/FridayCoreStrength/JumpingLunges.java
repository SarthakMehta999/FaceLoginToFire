...
import fiture.quiamco.com.homefiture.LoseExcercise.FridayCoreStrength.Rest.RestJumpingLunges;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(JumpingLunges.this,InsJumpingLunges.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(JumpingLunges.this, RestJumpingLunges.class);
