...
public class StandingBarbellCurls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_standing_barbell_curls);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(StandingBarbellCurls.this,DumbellRows.class);
                startActivity(im);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StandingBarbellCurls.this, WeeklyEctomorph.class);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(StandingBarbellCurls.this, AlternatingCurls.class);
                startActivity(intent);
