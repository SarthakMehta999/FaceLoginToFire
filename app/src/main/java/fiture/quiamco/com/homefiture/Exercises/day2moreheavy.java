...
//        loadImage();
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("Get into a forward lunge position with torso upright, core braced and hips square to your body, " +
                                "with your back foot elevated on the bench. Your leading leg should be half a metre or so in front of bench. " +
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(day2moreheavy.this, day2moreheavy1.class);
                startActivity(step);
