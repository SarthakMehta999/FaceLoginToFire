...
//        loadImage();
        ...
        start_timer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myCountDownTimer = new day2heavy.MyCountDownTimer(10000, 1000);
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Grab the parallel bars of a chin-up station. Palms should be facing each other. " +
                                "2.) Hang down at arm's length, be sure your arms do not come out of their sockets. Cross ankles behind you. " +
                                "This is the starting position." +
                                "  " +
                                "3.) Begin exercise by pulling your chest up to the bar, pause for brief moment, then slowly lower  " +
                                "yourself back down to the starting position. This completes one rep. Repeat as necessary. " )
                            ...
                            matchesRefTemp.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.hasChild("6")){
                                        Log.d("idOy","naaJOD");
                                        final DatabaseReference ref0 = dataSnapshot.getRef().child("7");
                                        final DatabaseReference ref1 = dataSnapshot.getRef().child("8");

                                        ref0.addListenerForSingleValueEvent(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                String status = dataSnapshot.child("status").getValue().toString();
                                                if(status.equalsIgnoreCase("unlock1")){
                                                            ...
                                                            if(dataSnapshot.hasChild(id)){
                                                                ...
                                                                refUserID.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                                        ref1.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                            ...
                                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                                ...
                                                                                if(status.equalsIgnoreCase("lock")){
                                                                                    Toast.makeText(day2heavy.this, "You have unlocked a new exercise!", Toast.LENGTH_SHORT).show();
                                                                                    ref1.child("status").setValue("unlock2");
                                                                                }
                                                                            }
                                                                        ...
                                                                        userPoints+=30;
                                                                        Toast.makeText(day2heavy.this, "Congratulations, you received 30 points!", Toast.LENGTH_LONG).show();
                                                                        refUserID.child("userPoints").setValue(userPoints);
                                                                        user.setUserPoints(String.valueOf(userPoints));
                                                                        Intent proc = new Intent(day2heavy.this, NavDrawer.class);
