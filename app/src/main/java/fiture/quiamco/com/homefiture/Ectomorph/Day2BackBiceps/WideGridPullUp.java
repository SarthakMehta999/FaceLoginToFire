...
public class WideGridPullUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wide_grid_pull_up);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(WideGridPullUp.this,WeeklyEctomorph.class);
                startActivity(im);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WideGridPullUp.this, WeeklyEctomorph.class);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WideGridPullUp.this, BentOverBarbell.class);
                startActivity(intent);
