...
import fiture.quiamco.com.homefiture.models.DailyChallengeModelForLose;
import fiture.quiamco.com.homefiture.models.User;

public class DailyChallengeForLose extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private ArrayList<DailyChallengeModelForLose> dailyChallenge;
    private User user;

    public DailyChallengeForLose(Context context, ArrayList<DailyChallengeModelForLose> dailyChallenge, User user) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof RecyclerView.ViewHolder){
            DailyChallengeForLose.ViewHolder viewHolder = (DailyChallengeForLose.ViewHolder) holder;
