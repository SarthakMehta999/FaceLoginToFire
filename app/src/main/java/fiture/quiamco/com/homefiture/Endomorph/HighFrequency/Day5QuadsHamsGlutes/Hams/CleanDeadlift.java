package fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day5QuadsHamsGlutes.Hams;
...
import fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day5QuadsHamsGlutes.Quads.Squats;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class CleanDeadlift extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clean_deadlift);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(CleanDeadlift.this,Squats.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CleanDeadlift.this, KettleBellOneLeggedDeadlift.class);
