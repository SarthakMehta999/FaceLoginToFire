...
public class exercise5mostheavyd2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise5mostheavyd2);
...
//        loadImage();
        ...
        start_timer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myCountDownTimer = new exercise5mostheavyd2.MyCountDownTimer(10000, 1000);
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Hold a dumbbell or kettlebell in one hand and step backward.  " +
                                "2.) Lower your body until your rear knee nearly touches the " +
                                "floor and your front thigh is parallel to the floor. " +
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(exercise5mostheavyd2.this, exercise6mostheavyd2.class);
                startActivity(step);
