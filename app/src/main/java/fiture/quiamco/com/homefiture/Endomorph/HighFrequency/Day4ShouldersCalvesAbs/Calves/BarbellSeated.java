package fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day4ShouldersCalvesAbs.Calves;
...
import fiture.quiamco.com.homefiture.Endomorph.HighFrequency.Day4ShouldersCalvesAbs.MilitaryPress;
import fiture.quiamco.com.homefiture.R;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class BarbellSeated extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barbell_seated);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(BarbellSeated.this,MilitaryPress.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BarbellSeated.this, BarbellStandingCalf.class);
