...
public class Day3GReadyPikePushUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day3_gready_pike_push_up);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Day3GReadyPikePushUp.this, Day3GTricepsDip.class);
