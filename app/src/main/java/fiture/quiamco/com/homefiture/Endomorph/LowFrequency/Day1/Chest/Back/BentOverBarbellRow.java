package fiture.quiamco.com.homefiture.Endomorph.LowFrequency.Day1.Chest.Back;
...
public class BentOverBarbellRow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bent_over_barbell_row2);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(BentOverBarbellRow.this,BenchPressIncline.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BentOverBarbellRow.this, WeeklyEndomorphLowFreq.class);
