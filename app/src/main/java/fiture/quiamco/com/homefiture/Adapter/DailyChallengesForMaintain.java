...
import fiture.quiamco.com.homefiture.models.DailyChallengesModelForMaintain;
import fiture.quiamco.com.homefiture.models.User;

public class DailyChallengesForMaintain extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {

    private Context context;
    private ArrayList<DailyChallengesModelForMaintain> dailyChallenge;
    private User user;

    public DailyChallengesForMaintain(Context context, ArrayList<DailyChallengesModelForMaintain> dailyChallenge, User user) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        DailyChallengesForMaintain.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof RecyclerView.ViewHolder){
            DailyChallengesForMaintain.ViewHolder viewHolder = (DailyChallengesForMaintain.ViewHolder) holder;
