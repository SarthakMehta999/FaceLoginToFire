package fiture.quiamco.com.homefiture.Endomorph.MediumFrequency.Day2BackShoulders.Shoulders;
...
import fiture.quiamco.com.homefiture.Endomorph.MediumFrequency.Day2BackShoulders.Back.BentOverBarbellRow;
...
public class DumbbellOverheadPress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dumbbell_overhead_press3);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(DumbbellOverheadPress.this,BentOverBarbellRow.class);
                startActivity(im);
            }
        });
