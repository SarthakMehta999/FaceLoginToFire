...
import fiture.quiamco.com.homefiture.WeeklyLosePainInLegs.Day1Instructions.InsHamstringStretch;
import fiture.quiamco.com.homefiture.WeeklyLosePainInLegs.Day1Instructions.InsQuadricepsStretch;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class Quadriceps_Stretch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quadriceps__stretch);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(getApplication(),InsQuadricepsStretch.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplication(), InsHamstringStretch.class);
