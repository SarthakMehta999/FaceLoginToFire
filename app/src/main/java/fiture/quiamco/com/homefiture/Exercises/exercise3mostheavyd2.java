...
public class exercise3mostheavyd2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise3mostheavyd2);
...
//        loadImage();
        ...
        start_timer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myCountDownTimer = new exercise3mostheavyd2.MyCountDownTimer(10000, 1000);
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Use a standing calf raise machine, or hold onto a sturdy object and stand on a block as shown.  " +
                                ...
                                "raising your heels as high as possible. Control the descent on each rep. " )
...
//                                Step_1.this.finish();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent step = new Intent(exercise3mostheavyd2.this, exercise4mostheavyd2.class);
                startActivity(step);
