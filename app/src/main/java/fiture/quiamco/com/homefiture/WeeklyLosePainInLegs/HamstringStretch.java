...
import fiture.quiamco.com.homefiture.WeeklyLosePainInLegs.Day1Instructions.InsHipFlexorsStretch;
import fiture.quiamco.com.homefiture.models.CircleCountDownView;

public class HamstringStretch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hamstring_stretch);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent im = new Intent(getApplication(),InsHamstringStretch.class);
                startActivity(im);
            }
        });
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplication(), InsHipFlexorsStretch.class);
