...
//        loadImage();
        ...
        start_timer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myCountDownTimer = new day4heavy.MyCountDownTimer(10000, 1000);
        ...
        inst.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                ...
                //set dialog message
                alertDialogBuilder
                        .setMessage("1.) Lie down on a flat bench with a dumbbell on each hand resting on top of your thighs. " +
                                ...
                                "3.) Hold for a second at the contracted position and repeat the movement for the prescribed amount of repetitions. " )
                            ...
                            matchesRefTemp.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.hasChild("6")){
                                        Log.d("idOy","naaJOD");
                                        final DatabaseReference ref0 = dataSnapshot.getRef().child("9");
                                        final DatabaseReference ref1 = dataSnapshot.getRef().child("10");

                                        ref0.addListenerForSingleValueEvent(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                String status = dataSnapshot.child("status").getValue().toString();
                                                if(status.equalsIgnoreCase("unlock3")){
                                                            ...
                                                            if(dataSnapshot.hasChild(id)){
                                                                ...
                                                                refUserID.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                                        ref1.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                            ...
                                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                                ...
                                                                                if(status.equalsIgnoreCase("lock")){
                                                                                    Toast.makeText(day4heavy.this, "You have unlocked a new exercise!", Toast.LENGTH_SHORT).show();
                                                                                    ref1.child("status").setValue("unlock4");
                                                                                }
                                                                            }
                                                                        ...
                                                                        userPoints+=30;
                                                                        Toast.makeText(day4heavy.this, "Congratulations, you received 30 points!", Toast.LENGTH_LONG).show();
                                                                        refUserID.child("userPoints").setValue(userPoints);
                                                                        user.setUserPoints(userPoints);
                                                                        Intent proc = new Intent(day4heavy.this, NavDrawer.class);
